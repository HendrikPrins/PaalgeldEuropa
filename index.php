            ...
            <div class="info2">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h2>Contact us</h2>
                            <p>Got questions, remarks or feedback about the website or about the project itself?  Send us an email at <a href="mailto:paalgeldeuropa@reinardvandalen.nl">paalgeldeuropa@reinardvandale.nl</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
