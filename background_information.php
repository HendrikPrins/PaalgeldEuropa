...
$_loadChosen = true;
beginPage('Paalgeld Europa - Background Information', true, 'Background Information');
?>
<p>
...
Taxes like the Paalgeld were levied all along the coast of the Zuiderzee, North Sea and in the Baltic Area.<br>
...
, when the central government took over the task of maintenance of the sea routes.<br>
...
but only the portbooks of Amsterdam have survived. These portbooks cover the periods 1742, a single year, 
...
the company paid a fixed sum for every ship. This administration has not survived.<br>
...
The cargoes of all other ships are registered in the portbooks. However, 
...
there are only additions of new products.<br>
For a more detailed description see chapter 3 of George M. Welling: <a href="http://dissertations.ub.rug.nl/faculties/arts/1998/g.m.welling/
">The Prize of Neutrality</a>
</p>
<?php
endPage();
?>